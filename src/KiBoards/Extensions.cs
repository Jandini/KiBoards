...
namespace KiBoards
{
    ...
    {     
        ...
        public static void WriteException(this IMessageSink messageSink, string message, Exception exception, [CallerMemberName] string method = "") => messageSink.OnMessage(new DiagnosticMessage($"{message}\n{exception.Message}{(exception.InnerException != null ? "\n" + exception.InnerException.Message : "")}"));
    }
}
