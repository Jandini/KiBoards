...
docker run --network kiboards-network -p 8089:80 -it -e ELASTICSEARCH_URI=http://kiboards-elastic:9200 -e ASPNETCORE_ENVIRONMENT=Development --rm ${ImageName}:${ImageTag}
